...
def generate_user_agent_pool(n=1000):
    pool = []
    platforms = ["Windows NT 10.0; Win64; x64", "X11; Linux x86_64"]
    for _ in range(n):
...
def display_banner():
    panel = Panel.fit(banner_text, title="[bold cyan]R-Dox By ~ RenXploit[/bold cyan]",
...
- Fitur Doxing (gunakan etis!) untuk nama, email, dan nomor telepon (otomatis mendeteksi kode negara)
- Riwayat Penelitian
